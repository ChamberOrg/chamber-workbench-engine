/**
 * Shared filesystem path helpers for Chamber user data.
 *
...
/** Directory name for the default Chamber home under the OS home. */
export const DSH_HOME_DIR_NAME = '.dsh'

/** Stable user-facing display form for the default Chamber home. */
export const DEFAULT_DSH_HOME_DISPLAY = `~/${DSH_HOME_DIR_NAME}`

/** Environment variable that overrides the default Chamber home. */
...
/**
 * Resolve the default Chamber home using Node's platform path rules.
...
/**
 * Resolve the single-root Chamber home.
 *
...
/**
 * Join path segments onto the resolved Chamber home.
