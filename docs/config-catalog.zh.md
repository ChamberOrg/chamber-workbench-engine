...
export interface Config {
  ...
  tools?: ToolsConfig
  /** Chamber home directory exposed to bash and used for local skill discovery. */
  dshHome?: string
...
export interface Config {
  ...
  tools?: ToolsConfig
  /** Chamber home directory shared by shell context and local skill discovery. */
  dshHome?: string
...
export interface Config {
  /** Chamber home directory exposed as `DSH_HOME`; defaults to `$DSH_HOME` or `~/.dsh`. */
  dshHome?: string
}
```
...
export interface Config {
  ...
  /** Chamber config root. Defaults to `$DSH_HOME` or `~/.dsh`. */
  dshHome?: string
...
export interface Config {
  /** Include the fixed Chamber identity before the deployment persona (default true). */
